...
!(function(t, i) {
  ...
  (S.extend = function(t) {
    ...
    for (var o in (((n.constructor = i).prototype = n), this))
      Object.prototype.hasOwnProperty.call(this, o) &&
        ...
        "__super__" !== o &&
        (i[o] = this[o]);
    return t.statics && (h(i, t.statics), delete t.statics), t.includes &&
      (
        (function(t) {
        ...
        delete t.includes
      ), n.options && (t.options = h(s(n.options), t.options)), h(
      n,
      t
    ), (n._initHooks = []), (n.callInitHooks = function() {
      if (!this._initHooksCalled) {
        e.callInitHooks &&
          e.callInitHooks.call(this), (this._initHooksCalled = !0);
    ...
    return (this.prototype._initHooks =
      this.prototype._initHooks || []), this.prototype._initHooks.push(e), this;
  });
  var Z = {
    on: function(t, i, e) {
    ...
    addEventParent: function(t) {
      return (this._eventParents =
        this._eventParents || {}), (this._eventParents[m(t)] = t), this;
    },
  ...
  (Z.addEventListener =
    Z.on), (Z.removeEventListener = Z.clearAllEventListeners = Z.off), (Z.addOneTimeEventListener = Z.once), (Z.fireEvent = Z.fire), (Z.hasEventListeners = Z.listens);
  var E = S.extend(Z);
  function k(t, i, e) {
  ...
  (k.prototype = {
    ...
    contains: function(t) {
      return (t = A(t)), Math.abs(t.x) <= Math.abs(this.x) &&
    ...
    extend: function(t) {
      return (t = A(t)), this.min || this.max
        ? (
    ...
    contains: function(t) {
      var i, e;
      return (t = ("number" == typeof t[0] || t instanceof k ? A : O)(
        t
      )) instanceof I
        ? ((i = t.min), (e = t.max))
        : (i = e = t), i.x >= this.min.x &&
        e.x <= this.max.x &&
        i.y >= this.min.y &&
        e.y <= this.max.y;
    },
  ...
  function q(t, i, e, n) {
    if (g(t))
      return (this._a = t[0]), (this._b = t[1]), (this._c =
        t[2]), void (this._d = t[3]);
  ...
  q.prototype = {
    ...
    _transform: function(t, i) {
      return (i = i || 1), (t.x = i * (this._a * t.x + this._b)), (t.y =
        i * (this._c * t.y + this._d)), t;
    },
  ...
  function pi(t) {
    return t.correspondingElement &&
      (t =
        t.correspondingElement), void 0 === t.className.baseVal ? t.className : t.className.baseVal;
  }
  function mi(t, i) {
    "opacity" in t.style
      ? (t.style.opacity = i)
    ...
    Lt && 0 === t.indexOf("touch")
      ...
      : bt && "dblclick" === t && !Zi()
        ...
        : "addEventListener" in i
          ...
          : "attachEvent" in i &&
            i.attachEvent("on" + t, c), (i[Ci] = i[Ci] || {}), (i[Ci][o] = c);
  }
  function Bi(t, i, e, n) {
    var o,
      s,
    ...
    Lt && 0 === i.indexOf("touch")
      ...
      : bt && "dblclick" === i && !Zi()
        ...
        : "removeEventListener" in t
          ...
          : "detachEvent" in t && t.detachEvent("on" + i, d), (t[Ci][_] = null);
  }
  function Ai(t) {
    ...
    Gi = E.extend({
      run: function(t, i, e, n) {
        this.stop(), (this._el = t), (this._inProgress = !0), (this._duration =
          e || 0.25), (this._easeOutPower =
          1 / Math.max(n || 0.5, 0.2)), (this._startPos = yi(
          t
        )), (this._offset = i.subtract(
          this._startPos
    ...
    Ki = E.extend({
      ...
      initialize: function(t, i) {
        (i = c(
          ...
          t
        ), this._initLayout(), (this._onResize = p(
          this._onResize,
          this
        )), this._initEvents(), i.maxBounds &&
          this.setMaxBounds(i.maxBounds), void 0 !== i.zoom &&
          (this._zoom = this._limitZoom(i.zoom)), i.center &&
          void 0 !== i.zoom &&
          this.setView(j(i.center), i.zoom, {
            reset: !0
          }), this.callInitHooks(), (this._zoomAnimated =
          ii && vt && !Tt && this.options.zoomAnimation), this._zoomAnimated &&
          (
      ...
      zoomIn: function(t, i) {
        return (t = t || (vt ? this.options.zoomDelta : 1)), this.setZoom(
          this._zoom + t,
          i
        );
      },
      ...
      panInsideBounds: function(t, i) {
        ...
        return e.equals(n) ||
          this.panTo(n, i), (this._enforcingBounds = !1), this;
      },
      ...
      project: function(t, i) {
        return (i =
          void 0 === i ? this._zoom : i), this.options.crs.latLngToPoint(
          j(t),
          i
        );
      },
      unproject: function(t, i) {
        return (i =
          void 0 === i ? this._zoom : i), this.options.crs.pointToLatLng(
          A(t),
          i
        );
      },
      ...
      _initLayout: function() {
        ...
        (this._fadeAnimated = this.options.fadeAnimation && vt), ci(
          t,
          "leaflet-container" +
            (bt ? " leaflet-touch" : "") +
            (zt ? " leaflet-retina" : "") +
      ...
      _initPanes: function() {
        ...
        (this._paneRenderers = {}), (this._mapPane = this.createPane(
          "mapPane",
          this._container
        )), vi(this._mapPane, new k(0, 0)), this.createPane(
          "tilePane"
        ), this.createPane("shadowPane"), this.createPane(
          "overlayPane"
      ...
      _resetView: function(t, i) {
        ...
        var e = !this._loaded;
        (this._loaded = !0), (i = this._limitZoom(i)), this.fire(
          "viewprereset"
        );
        var n = this._zoom !== i;
      ...
      _initEvents: function(t) {
        ...
        i(
          ...
          i(window, "resize", this._onResize, this), vt &&
  ...
  var Xi = S.extend({
    ...
    addTo: function(t) {
      ...
      return ci(i, "leaflet-control"), -1 !== e.indexOf("bottom")
        ? n.insertBefore(i, n.firstChild)
        : n.appendChild(i), this._map.on("unload", this.remove, this), this;
    },
    remove: function() {
      return this._map &&
        (
  ...
  Ki.include({
    ...
    _clearControlPos: function() {
      ...
      ri(this._controlContainer), delete this._controlCorners, delete this
        ._controlContainer;
    }
  });
  var Ji = Xi.extend({
      ...
      _initLayout: function() {
        ...
        (o.href = "#"), (o.title = "Layers"), bt
          ? (zi(o, "click", Ni), zi(o, "click", this.expand, this))
          : zi(o, "focus", this.expand, this), e ||
          this.expand(), (this._baseLayersList = si(
          "div",
          t + "-base",
          n
        )), (this._separator = si(
          ...
          t + "-separator",
          n
        )), (this._overlaysList = si("div", t + "-overlays", n)), i.appendChild(
          n
        );
      },
      ...
      _update: function() {
        ...
        ai(this._baseLayersList), ai(
          this._overlaysList
        ), (this._layerControlInputs = []);
        for (var t, i, e, n = 0, o = 0; o < this._layers.length; o++)
          (e = this._layers[o]), this._addItem(e), (i = i || e.overlay), (t =
            t || !e.overlay), (n += e.overlay ? 0 : 1);
      ...
      _addItem: function(t) {
        ...
        t.overlay
          ...
          : (i = this._createRadioElement(
              ...
              n
            )), this._layerControlInputs.push(i), (i.layerId = m(t.layer)), zi(
          i,
          "click",
          this._onInputClick,
          this
        ...
        return e.appendChild(s), s.appendChild(i), s.appendChild(o), (t.overlay
          ? this._overlaysList
      ...
      _onInputClick: function() {
        ...
        for (var s = e.length - 1; 0 <= s; s--)
          (t = e[s]), (i = this._getLayer(t.layerId).layer), t.checked
            ? n.push(i)
            : t.checked || o.push(i);
    ...
    $i = Xi.extend({
      ...
      _createButton: function(t, i, e, n, o) {
        var s = si("a", e, n);
        return (s.innerHTML = t), (s.href = "#"), (s.title = i), s.setAttribute(
          "role",
          "button"
        ), s.setAttribute("aria-label", i), Oi(s), zi(s, "click", Ni), zi(
          s,
          "click",
          o,
          this
      ...
      _updateDisabled: function() {
        var t = this._map,
          i = "leaflet-disabled";
        _i(this._zoomInButton, i), _i(this._zoomOutButton, i), (!this
          ._disabled &&
          t._zoom !== t.getMinZoom()) ||
          ci(this._zoomOutButton, i), (!this._disabled &&
  ...
  var Qi = Xi.extend({
      ...
      onAdd: function(t) {
        var i = "leaflet-control-scale",
          e = si("div", i),
          n = this.options;
        return this._addScales(n, i + "-line", e), t.on(
      ...
      _addScales: function(t, i, e) {
        t.metric && (this._mScale = si("div", i, e)), t.imperial &&
      ...
      _updateScale: function(t, i, e) {
        (t.style.width =
          Math.round(this.options.maxWidth * e) + "px"), (t.innerHTML = i);
      },
    ...
    te = Xi.extend({
      ...
      onAdd: function(t) {
        for (var i in (
          ((t.attributionControl = this)._container = si(
            "div",
  ...
  (Xi.Layers = Ji), (Xi.Zoom = $i), (Xi.Scale = Qi), (Xi.Attribution = te), (Yi.layers = function(
    t,
    i,
    e
  ) {
  ...
  var ee,
    ...
    ae = E.extend({
      ...
      _updatePosition: function() {
        ...
        this.fire("predrag", t), vi(this._element, this._newPos), this.fire(
          "drag",
          t
        );
      },
      ...
      finishDrag: function() {
        for (var t in (
          ...
          Si(document, re[t], this._onMove, this), Si(
            document,
            se[t],
            this._onUp,
            this
    ...
    return 8 & e
      ...
      : 4 & e
        ...
        : 2 & e
          ...
          : 1 & e &&
            ((s = u.x), (r = t.y + h * (u.x - t.x) / a)), new k(s, r, o);
  }
  function _e(t, i) {
    var e = 0;
    return t.x < i.min.x
      ? (e |= 1)
      : t.x > i.max.x &&
        (e |= 2), t.y < i.min.y ? (e |= 4) : t.y > i.max.y && (e |= 8), e;
  }
  function de(t, i, e, n) {
    var o,
      s = i.x,
      ...
      (1 < (o = ((t.x - s) * a + (t.y - r) * h) / u)
        ...
        : 0 < o &&
          (
            (s += a * o),
            (r += h * o)
          )), (a = t.x - s), (h = t.y - r), n ? a * a + h * h : new k(s, r);
  }
  function pe(t) {
  ...
  Ki.include({
    ...
    _updateZoomLevels: function() {
      ...
      (this._layersMaxZoom = i === -1 / 0 ? void 0 : i), (this._layersMinZoom =
        t === 1 / 0 ? void 0 : t), e !== this._getZoomSpan() &&
  ...
  var Ze = Se.extend({
      ...
      _getIconUrl: function(t) {
        return Ze.imagePath || (Ze.imagePath = this._detectIconPath()), (this
          .options.imagePath || Ze.imagePath) +
    ...
    Ee = ie.extend({
      ...
      addHooks: function() {
        ...
        this._draggable ||
          (this._draggable = new ae(t, t, !0)), this._draggable
          .on(
            {
          ...
          .enable(), ci(t, "leaflet-marker-draggable");
      },
      ...
      _onDrag: function(t) {
        ...
        e &&
          vi(
            e,
            n
          ), (i._latlng = o), (t.latlng = o), (t.oldLatLng = this._oldLatLng), i
          .fire("move", t)
          .fire("drag", t);
      },
      _onDragEnd: function(t) {
        z(this._panRequest), delete this._oldLatLng, this._marker
          .fire("moveend")
          .fire("dragend", t);
      }
    }),
    ke = Me.extend({
      ...
      _initIcon: function() {
        ...
        e !== this._icon &&
          ...
          (e.tabIndex = "0"), (this._icon = e), t.riseOnHover &&
          this.on({
        ...
        o !== this._shadow && (this._removeShadow(), (s = !0)), o &&
          (ci(o, i), (o.alt = "")), (this._shadow = o), t.opacity < 1 &&
          this._updateOpacity(), n &&
          this.getPane().appendChild(this._icon), this._initInteraction(), o &&
          s &&
      ...
      _removeIcon: function() {
        this.options.riseOnHover &&
          this.off({
            mouseover: this._bringToFront,
            mouseout: this._resetZIndex
          }), ri(this._icon), this.removeInteractiveTarget(
          this._icon
        ), (this._icon = null);
      },
      ...
      _setPos: function(t) {
        this._icon && vi(this._icon, t), this._shadow &&
          vi(this._shadow, t), (this._zIndex =
  ...
  var Oe = Be.extend({
    ...
    addLatLng: function(t, i) {
      return (i = i || this._defaultShape()), (t = j(t)), i.push(
        t
  ...
  var Re = Oe.extend({
    ...
    getCenter: function() {
      ...
      for (t = s = r = a = 0, i = l - 1; t < l; i = t++)
        (e = u[t]), (n = u[i]), (o = e.y * n.x - n.y * e.x), (r +=
          (e.x + n.x) * o), (a += (e.y + n.y) * o), (s += 3 * o);
      return (h =
        0 === s ? u[0] : [r / s, a / s]), this._map.layerPointToLatLng(h);
    },
    _convertLatLngs: function(t) {
    ...
    _setLatLngs: function(t) {
      Oe.prototype._setLatLngs.call(this, t), pe(this._latlngs) &&
  ...
  function Fe(t, i) {
    return (i =
      "number" == typeof i
        ? i
        : 6), void 0 !== t.alt ? [r(t.lng, i), r(t.lat, i), r(t.alt, i)] : [r(t.lng, i), r(t.lat, i)];
  }
  function Ue(t, i, e, n) {
  ...
  var Ye = Ke,
    Xe = Me.extend({
      ...
      onRemove: function() {
        ri(this._image), this.options.interactive &&
      ...
      _initImage: function() {
        ...
        ci(i, "leaflet-image-layer"), this._zoomAnimated &&
          ci(i, "leaflet-zoom-animated"), this.options.className &&
          ci(
            i,
            this.options.className
          ), (i.onselectstart = a), (i.onmousemove = a), (i.onload = p(
          this.fire,
          this,
          "load"
        )), (i.onerror = p(this._overlayOnError, this, "error")), (!this.options
          .crossOrigin &&
      ...
      _reset: function() {
        var t = this._image,
          ...
          e = i.getSize();
        vi(t, i.min), (t.style.width = e.x + "px"), (t.style.height =
          e.y + "px");
      },
      _updateOpacity: function() {
    ...
    Je = Xe.extend({
      ...
      _initImage: function() {
        ...
        if (
          ...
          g(this._url) || (this._url = [this._url]), !this.options
            .keepAspectRatio &&
            Object.prototype.hasOwnProperty.call(i.style, "objectFit") &&
            (i.style.objectFit = "fill"), (i.autoplay = !!this.options
            .autoplay), (i.loop = !!this.options.loop), (i.muted = !!this
            .options.muted);
  ...
  var $e = Xe.extend({
    _initImage: function() {
      ...
      ci(t, "leaflet-image-layer"), this._zoomAnimated &&
        ci(t, "leaflet-zoom-animated"), this.options.className &&
        ci(
          t,
          this.options.className
        ), (t.onselectstart = a), (t.onmousemove = a);
    }
  });
  var Qe = Me.extend({
      ...
      onAdd: function(t) {
        (this._zoomAnimated = t._zoomAnimated), this._container ||
          ...
          mi(this._container, 0), clearTimeout(
          this._removeTimeout
        ), this.getPane().appendChild(
          this._container
        ), this.update(), t._fadeAnimated &&
          mi(this._container, 1), this.bringToFront();
      },
      onRemove: function(t) {
        t._fadeAnimated
          ? (
      ...
      setLatLng: function(t) {
        return (this._latlng = j(t)), this._map &&
    ...
    tn = Qe.extend({
      ...
      _initLayout: function() {
        ...
        (this._contentNode = si("div", i + "-content", n)), Oi(e), Ii(
          this._contentNode
        ), zi(e, "contextmenu", Ai), (this._tipContainer = si(
          "div",
          i + "-tip-container",
          e
        )), (this._tip = si("div", i + "-tip", this._tipContainer)), this
          .options.closeButton &&
          (
      ...
      _updateLayout: function() {
        ...
        (e = Math.max(e, this.options.minWidth)), (i.width =
          e + 1 + "px"), (i.whiteSpace = ""), (i.height = "");
        var n = t.offsetHeight,
          o = this.options.maxHeight,
          s = "leaflet-popup-scrolled";
        o && o < n
          ? ((i.height = o + "px"), ci(t, s))
          : _i(t, s), (this._containerWidth = this._container.offsetWidth);
      },
      _animateZoom: function(t) {
  ...
  Ki.mergeOptions({ closePopupOnClick: !0 }), Ki.include({
    openPopup: function(t, i, e) {
      return t instanceof tn || (t = new tn(e).setContent(t)), i &&
  ...
  var en = Qe.extend({
    ...
    onAdd: function(t) {
      Qe.prototype.onAdd.call(this, t), this.setOpacity(
    ...
    _setPosition: function(t) {
      ...
      (t = t.subtract(A(i, c, !0)).add(u).add(l)), _i(
        n,
        "leaflet-tooltip-right"
      ), _i(n, "leaflet-tooltip-left"), _i(n, "leaflet-tooltip-top"), _i(
        n,
        "leaflet-tooltip-bottom"
      ), ci(n, "leaflet-tooltip-" + r), vi(n, t);
    },
    _updatePosition: function() {
  ...
  Ki.include({
    openTooltip: function(t, i, e) {
      return t instanceof en || (t = new en(e).setContent(t)), i &&
  ...
  var nn = Se.extend({
    ...
    createIcon: function(t) {
      ...
      return n.html instanceof Element
        ...
        : (e.innerHTML = !1 !== n.html ? n.html : ""), n.bgPos &&
        (
          (i = A(n.bgPos)),
  ...
  var on = Me.extend({
    ...
    onRemove: function(t) {
      this._removeAllTiles(), ri(this._container), t._removeZoomLimit(
        this
      ), (this._container = null), (this._tileZoom = void 0);
    },
    bringToFront: function() {
      return this._map &&
        (hi(this._container), this._setAutoZIndex(Math.max)), this;
    },
    bringToBack: function() {
      return this._map &&
        (ui(this._container), this._setAutoZIndex(Math.min)), this;
    },
    getContainer: function() {
      return this._container;
    },
    ...
    _setAutoZIndex: function(t) {
      for (
        ...
        (i = e[o].style.zIndex), e[o] !== this._container &&
          i &&
          (n = t(n, +i));
      isFinite(n) &&
    ...
    _updateLevels: function() {
      ...
      if (void 0 !== t) {
        for (var e in this._levels)
          (e = Number(e)), this._levels[e].el.children.length || e === t
            ? (
    ...
    _invalidateAll: function() {
      for (var t in this._levels)
        ri(this._levels[t].el), this._onRemoveLevel(Number(t)), delete this
          ._levels[t];
          ...
          if (1 < Math.abs(e - this._tileZoom)) this._setView(t, e);
            ...
            for (var c = o.min.y; c <= o.max.y; c++)
              for (var _ = o.min.x; _ <= o.max.x; _++) {
                var d,
                  p = new k(_, c);
                (p.z = this._tileZoom), this._isValidTile(p) &&
    ...
    _initTile: function(t) {
      ...
      (t.style.width = i.x + "px"), (t.style.height =
        i.y + "px"), (t.onselectstart = a), (t.onmousemove = a), it &&
        this.options.opacity < 1 &&
        mi(t, this.options.opacity), ot &&
        !st &&
    ...
    _addTile: function(t, i) {
      ...
      this._initTile(o), this.createTile.length < 2 &&
        M(p(this._tileReady, this, t, null, o)), vi(o, e), (this._tiles[n] = {
        el: o,
        coords: t,
        current: !0
  ...
  var sn = on.extend({
    ...
    initialize: function(t, i) {
      (this._url = t), (i = c(this, i)).detectRetina &&
        zt &&
        0 < i.maxZoom &&
        (
        ...
        (i.subdomains = i.subdomains.split("")), ot ||
        this.on("tileunload", this._onTileRemove);
    },
    setUrl: function(t, i) {
      return this._url === t && void 0 === i && (i = !0), (this._url = t), i ||
        this.redraw(), this;
    },
    createTile: function(t, i) {
      var e = document.createElement("img");
      return zi(e, "load", p(this._tileOnLoad, this, i, e)), zi(
        e,
        "error",
        p(this._tileOnError, this, i, e)
      ), (!this.options.crossOrigin && "" !== this.options.crossOrigin) ||
        (e.crossOrigin =
          !0 === this.options.crossOrigin
            ? ""
            : this.options.crossOrigin), (e.alt = ""), e.setAttribute(
        "role",
        "presentation"
      ), (e.src = this.getTileUrl(t)), e;
    },
    ...
    _getZoomForUrl: function() {
      var t = this._tileZoom,
        i = this.options.maxZoom;
      return this.options.zoomReverse && (t = i - t), t +
    ...
    _removeTile: function(t) {
      var i = this._tiles[t];
      if (i)
        return at || i.el.setAttribute("src", y), on.prototype._removeTile.call(
          this,
          t
        );
    },
  ...
  var hn = Me.extend({
    ...
    un = hn.extend({
      ...
      _initContainer: function() {
        ...
        zi(t, "mousemove", this._onMouseMove, this), zi(
          t,
      ...
      _destroyContainer: function() {
        z(this._redrawRequest), delete this._ctx, ri(this._container), Si(
          this._container
      ...
      _reset: function() {
        hn.prototype._reset.call(this), this._postponeUpdatePaths &&
      ...
      _initPath: function(t) {
        ...
        this._drawLast &&
          (this._drawLast.next = i), (this._drawLast = i), (this._drawFirst =
      ...
      _removePath: function(t) {
        var i = t._order,
          e = i.next,
          n = i.prev;
        e ? (e.prev = n) : (this._drawLast = n), n
          ? (n.next = e)
          : (this._drawFirst = e), delete t._order, delete this._layers[
          m(t)
        ], this._requestRedraw(t);
      },
      ...
      _draw: function() {
        ...
        for (var n = this._drawFirst; n; n = n.next)
          (t = n.layer), (!e || (t._pxBounds && t._pxBounds.intersects(e))) &&
            t._updatePath();
  ...
  var cn = (function() {
    ...
    _n = {
      ...
      _initPath: function(t) {
        ...
        ), (i.coordsize = "1 1"), (t._path = cn("path")), i.appendChild(
          t._path
    ...
    pn = hn.extend({
      ...
      _initContainer: function() {
        (this._container = dn("svg")), this._container.setAttribute(
          "pointer-events",
          "none"
        ), (this._rootGroup = dn("g")), this._container.appendChild(
          this._rootGroup
        );
      },
      _destroyContainer: function() {
        ri(this._container), Si(this._container), delete this
      ...
      _initPath: function(t) {
        ...
        t.options.className && ci(i, t.options.className), t.options
          .interactive && ci(i, "leaflet-interactive"), this._updateStyle(
          t
        ), (this._layers[m(t)] = t);
      },
      _addPath: function(t) {
      ...
      _removePath: function(t) {
        ri(t._path), t.removeInteractiveTarget(t._path), delete this._layers[
          m(t)
        ];
      },
      _updatePath: function(t) {
  ...
  var gn = ie.extend({
    ...
    _onMouseDown: function(t) {
      ...
      this._clearDeferredResetState(), this._resetState(), Xt(), xi(), (this._startPoint = this._map.mouseEventToContainerPoint(
        t
      )), zi(
        document,
        {
    ...
    _onMouseMove: function(t) {
      ...
      var i = new I(this._point, this._startPoint),
        e = i.getSize();
      vi(this._box, i.min), (this._box.style.width =
  ...
  var yn = ie.extend({
    ...
    removeHooks: function() {
      _i(this._map._container, "leaflet-grab"), _i(
        this._map._container,
        "leaflet-touch-drag"
    ...
    _onDragStart: function() {
      var t,
        i = this._map;
      i._stop(), this._map.options.maxBounds &&
      this._map.options.maxBoundsViscosity
        ...
        : (this._offsetLimit = null), i.fire("movestart").fire("dragstart"), i
    ...
    _onZoomEnd: function() {
      ...
      (this._initialWorldOffset = i.subtract(
        t
      ).x), (this._worldWidth = this._map.getPixelWorldBounds().getSize().x);
    },
  ...
  var Pn = ie.extend({
    ...
    _onDown: function(t) {
      if (t.touches) {
        ...
        var i = t.touches[0],
          e = i.target;
        (this._startPos = this._newPos = new k(
          i.clientX,
          i.clientY
        )), e.tagName &&
          "a" === e.tagName.toLowerCase() &&
          ci(e, "leaflet-active"), (this._holdTimeout = setTimeout(
          p(function() {
            this._isTapValid() &&
              (
                (this._fireClick = !1),
          ...
          1e3
        )), this._simulateEvent("mousedown", i), zi(
          document,
    ...
    _onUp: function(t) {
      var i, e;
      clearTimeout(this._holdTimeout), Si(
        document,
        { touchmove: this._onMove, touchend: this._onUp },
        this
      ), this._fireClick &&
    ...
    _onMove: function(t) {
      var i = t.touches[0];
      (this._newPos = new k(i.clientX, i.clientY)), this._simulateEvent(
        "mousemove",
        i
      );
    },
    _simulateEvent: function(t, i) {
      ...
      (e._simulated = !0), (i.target._simulatedClick = !0), e.initMouseEvent(
        t,
        !0,
        !0,
        window,
  ...
  var Ln = ie.extend({
    addHooks: function() {
      ci(this._map._container, "leaflet-touch-zoom"), zi(
        this._map._container,
        "touchstart",
        this._onTouchStart,
        this
    ...
    removeHooks: function() {
      _i(this._map._container, "leaflet-touch-zoom"), Si(
        this._map._container,
        "touchstart",
        this._onTouchStart,
        this
    ...
    _onTouchMove: function(t) {
      if (t.touches && 2 === t.touches.length && this._zooming) {
        ...
        this._moved || (i._moveStart(!0, !1), (this._moved = !0)), z(
          this._animRequest
        );
  ...
  Ki.addInitHook(
    ...
    "touchZoom",
    Ln
  ), (Ki.BoxZoom = gn), (Ki.DoubleClickZoom = vn), (Ki.Drag = yn), (Ki.Keyboard = xn), (Ki.ScrollWheelZoom = wn), (Ki.Tap = Pn), (Ki.TouchZoom = Ln), (t.version = "1.7.1"), (t.Control = Xi), (t.control = Yi), (t.Browser = Bt), (t.Evented = E), (t.Mixin = ne), (t.Util = C), (t.Class = S), (t.Handler = ie), (t.extend = h), (t.bind = p), (t.stamp = m), (t.setOptions = c), (t.DomEvent = qi), (t.DomUtil = Mi), (t.PosAnimation = Gi), (t.Draggable = ae), (t.LineUtil = fe), (t.PolyUtil = ye), (t.Point = k), (t.point = A), (t.Bounds = I), (t.bounds = O), (t.Transformation = q), (t.transformation = G), (t.Projection = Pe), (t.LatLng = D), (t.latLng = j), (t.LatLngBounds = R), (t.latLngBounds = N), (t.CRS = H), (t.GeoJSON = Ne), (t.geoJSON = Ke), (t.geoJson = Ye), (t.Layer = Me), (t.LayerGroup = ze), (t.layerGroup = function(
    t,
    i
  ) {
    return new ze(t, i);
    ...
    return new ke(t, i);
  }), (t.TileLayer = sn), (t.tileLayer = rn), (t.GridLayer = on), (t.gridLayer = function(
    t
  ) {
    return new on(t);
  }), (t.SVG = pn), (t.svg = mn), (t.Renderer = hn), (t.Canvas = un), (t.canvas = ln), (t.Path = Be), (t.CircleMarker = Ae), (t.circleMarker = function(
    t,
    i
  ) {
    return new Ae(t, i);
