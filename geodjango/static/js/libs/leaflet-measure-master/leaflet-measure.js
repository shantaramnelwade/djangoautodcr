!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# "></a> <div class="{{ model.className }}-interaction js-interaction"><a href=# class="js-start start text-dark">Measurement</a></div>  <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancel</a></li> <li><a href=# class="js-finish finish">Finish</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports = "<div class=group>";
  },
  function(e, t, r) {
    e.exports = "<h3>Point location</h3> <p>{{ model.lastCoord.dms.y }} ";
  },
  function(e, t, r) {
  ...
  function(e, t, r) {
    e.exports =
      '<p class="text-bold">Area measurement</p> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perimeter</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Center on this area</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Delete</a></li> </ul> ';
  }
]);
