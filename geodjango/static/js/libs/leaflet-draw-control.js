...
!(function(t, e, i) {
  (L.drawVersion = "0.4.2"), (L.Draw = {}), (L.drawLocal = {
  ...
  }), (L.Draw.Event = {}), (L.Draw.Event.CREATED =
    "draw:created"), (L.Draw.Event.EDITED =
    "draw:edited"), (L.Draw.Event.DELETED =
    "draw:deleted"), (L.Draw.Event.DRAWSTART =
    "draw:drawstart"), (L.Draw.Event.DRAWSTOP =
    "draw:drawstop"), (L.Draw.Event.DRAWVERTEX =
    "draw:drawvertex"), (L.Draw.Event.EDITSTART =
    "draw:editstart"), (L.Draw.Event.EDITMOVE =
    "draw:editmove"), (L.Draw.Event.EDITRESIZE =
    "draw:editresize"), (L.Draw.Event.EDITVERTEX =
    "draw:editvertex"), (L.Draw.Event.EDITSTOP =
    "draw:editstop"), (L.Draw.Event.DELETESTART =
    "draw:deletestart"), (L.Draw.Event.DELETESTOP =
    "draw:deletestop"), (L.Draw =
    L.Draw || {}), (L.Draw.Feature = L.Handler.extend({
    includes: L.Mixin.Events,
    initialize: function(t, e) {
      (this._map = t), (this._container = t._container), (this._overlayPane =
        t._panes.overlayPane), (this._popupPane = t._panes.popupPane), e &&
        e.shapeOptions &&
    ...
    _cancelDrawing: function(t) {
      this._map.fire("draw:canceled", { layerType: this.type }), 27 ===
        t.keyCode && this.disable();
    }
    ...
    initialize: function(t, e) {
      L.Browser.touch &&
        (this.options.icon = this.options.touchIcon), (this.options.drawError.message =
        L.drawLocal.draw.handlers.polyline.error), e &&
        e.drawError &&
        ...
        L.Draw.Polyline.TYPE), L.Draw.Feature.prototype.initialize.call(
        this,
        t,
        e
      );
    ...
    addHooks: function() {
      L.Draw.Feature.prototype.addHooks.call(this), this._map &&
        (
          (this._markers = []),
    ...
    removeHooks: function() {
      L.Draw.Feature.prototype.removeHooks.call(
        this
      ), this._clearHideErrorTimeout(), this._cleanUpShape(), this._map.removeLayer(
        this._markerGroup
      ), delete this._markerGroup, delete this._markers, this._map.removeLayer(
        this._poly
      ), delete this._poly, this._mouseMarker
        .off("mousedown", this._onMouseDown, this)
        .off("mouseout", this._onMouseOut, this)
        .off("mouseup", this._onMouseUp, this)
        .off("mousemove", this._onMouseMove, this), this._map.removeLayer(
        this._mouseMarker
      ), delete this._mouseMarker, this._clearGuides(), this._map
        .off("mouseup", this._onMouseUp, this)
    ...
    deleteLastVertex: function() {
      if (!(this._markers.length <= 1)) {
        var t = this._markers.pop(),
          ...
          i = e.getLatLngs(),
          o = i.splice(-1, 1)[0];
        this._poly.setLatLngs(i), this._markerGroup.removeLayer(
          t
        ), e.getLatLngs().length < 2 &&
          this._map.removeLayer(e), this._vertexChanged(o, !1);
      }
    },
    ...
    _finishShape: function() {
      ...
      return (!this.options.allowIntersection && e) || !this._shapeIsValid()
        ? void this._showErrorTooltip()
        : (
            this._fireCreatedEvent(),
            this.disable(),
    ...
    _onMouseMove: function(t) {
      ...
      (this._currentLatLng = i), this._updateTooltip(i), this._updateGuide(
        e
    ...
    _vertexChanged: function(t, e) {
      ...
      }), this._updateFinishHandler(), this._updateRunningMeasure(
        t,
        e
      ), this._clearGuides(), this._updateTooltip();
    },
    ...
    _updateFinishHandler: function() {
      ...
      t > 1 && this._markers[t - 1].on("click", this._finishShape, this), t >
        2 && this._markers[t - 2].off("click", this._finishShape, this);
    },
    ...
    _updateTooltip: function(t) {
      ...
      t && this._tooltip.updatePosition(t), this._errorShown ||
        this._tooltip.updateContent(e);
    },
    _drawGuide: function(t, e) {
      ...
      for (
        ...
        (i = h / s), (o = {
          ...
          : this.options.shapeOptions.color), L.DomUtil.setPosition(n, o);
    },
    ...
    _getMeasurementString: function() {
      ...
      return (t =
        ...
        e.distanceTo(i)), L.GeometryUtil.readableDistance(
        t,
        this.options.metric,
        this.options.feet
      );
    ...
    _showErrorTooltip: function() {
      (this._errorShown = !0), this._tooltip
        .showAsError()
        .updateContent({
          text: this.options.drawError.message
        }), this._updateGuideColor(
        this.options.drawError.color
      ), this._poly.setStyle({
        color: this.options.drawError.color
      }), this._clearHideErrorTimeout(), (this._hideErrorTimeout = setTimeout(
        L.Util.bind(this._hideErrorTooltip, this),
        this.options.drawError.timeout
      ));
    },
    _hideErrorTooltip: function() {
      (this._errorShown = !1), this._clearHideErrorTimeout(), this._tooltip
        .removeError()
        .updateContent(this._getTooltipText()), this._updateGuideColor(
    ...
    initialize: function(t, e) {
      L.Draw.Polyline.prototype.initialize.call(this, t, e), (this.type =
        L.Draw.Polygon.TYPE);
    },
    _updateFinishHandler: function() {
      var t = this._markers.length;
      1 === t && this._markers[0].on("click", this._finishShape, this), t > 2 &&
        (
    ...
    initialize: function(t, e) {
      (this._endLabelText =
        L.drawLocal.draw.handlers.simpleshape.tooltip.end), L.Draw.Feature.prototype.initialize.call(
        this,
        t,
        e
      );
    ...
    removeHooks: function() {
      L.Draw.Feature.prototype.removeHooks.call(this), this._map &&
        (
    ...
    _onMouseDown: function(t) {
      (this._isDrawing = !0), (this._startLatLng = t.latlng), L.DomEvent
    ...
    _onMouseMove: function(t) {
      var e = t.latlng;
      this._tooltip.updatePosition(e), this._isDrawing &&
        (
          this._tooltip.updateContent(this._getTooltipText()),
          this._drawShape(e)
        );
    ...
    _onMouseUp: function() {
      this._shape && this._fireCreatedEvent(), this.disable(), this.options
        .repeatMode && this.enable();
    }
    ...
    initialize: function(t, e) {
      (this.type = L.Draw.Rectangle.TYPE), (this._initialLabelText =
        L.drawLocal.draw.handlers.rectangle.tooltip.start), L.Draw.SimpleShape.prototype.initialize.call(
        this,
        t,
        e
      );
    ...
    initialize: function(t, e) {
      (this.type = L.Draw.Circle.TYPE), (this._initialLabelText =
        L.drawLocal.draw.handlers.circle.tooltip.start), L.Draw.SimpleShape.prototype.initialize.call(
        this,
        t,
        e
      );
    ...
    _onMouseMove: function(t) {
      ...
      this._tooltip.updatePosition(i), this._isDrawing &&
        (
          this._drawShape(i),
    ...
    initialize: function(t, e) {
      (this.type =
        L.Draw.Marker.TYPE), L.Draw.Feature.prototype.initialize.call(
        this,
        t,
        e
      );
    ...
    _onMouseMove: function(t) {
      var e = t.latlng;
      this._tooltip.updatePosition(e), this._mouseMarker.setLatLng(e), this
        ._marker
    ...
    _onClick: function() {
      this._fireCreatedEvent(), this.disable(), this.options.repeatMode &&
        this.enable();
    },
    _onTouch: function(t) {
    ...
    options: {},
    initialize: function(t, e) {
      (this.latlngs = [t._latlngs]), t._holes &&
        (this.latlngs = this.latlngs.concat(
          t._holes
        )), (this._poly = t), L.setOptions(this, e), this._poly.on(
        "revert-edited",
        this._updateLatLngs,
        this
      );
    ...
    _updateLatLngs: function(t) {
      (this.latlngs = [t.layer._latlngs]), t.layer._holes &&
    ...
    initialize: function(t, e, i) {
      L.Browser.touch &&
        (this.options.icon = this.options.touchIcon), (this._poly = t), i &&
        i.drawError &&
        (i.drawError = L.Util.extend(
          {},
          this.options.drawError,
          i.drawError
        )), (this._latlngs = e), L.setOptions(this, i);
    },
    _defaultShape: function() {
      return L.Polyline._flat
    ...
    addHooks: function() {
      ...
      t instanceof L.Polygon ||
        ...
        ), t.setStyle(t.options.editing), this._poly._map &&
        (
    ...
    removeHooks: function() {
      var t = this._poly;
      t.setStyle(t.options.original), t._map &&
        (
    ...
    _initMarkers: function() {
      ...
      for (t = 0, i = n.length; t < i; t++)
        (o = this._createMarker(n[t], t)), o.on(
          "click",
          this._onMarkerClick,
          this
    ...
    _createMarker: function(t, e) {
      ...
      return (i._origLatLng = t), (i._index = e), i
        ...
        .on("MSPointerUp", this._fireEdit, this), this._markerGroup.addLayer(
        i
      ), i;
    },
    ...
    _removeMarker: function(t) {
      var e = t._index;
      this._markerGroup.removeLayer(t), this._markers.splice(
        e,
        1
      ), this._spliceLatLngs(e, 1), this._updateIndexes(e, -1), t
    ...
    _fireEdit: function() {
      (this._poly.edited = !0), this._poly.fire("edit"), this._poly._map.fire(
    ...
    _onMarkerDrag: function(t) {
      ...
      if (
        ...
        if (!i.options.poly.allowIntersection && i.intersects()) {
          ...
          i.setStyle({ color: this.options.drawError.color }), 0 !==
            L.version.indexOf("0.7") &&
            e.dragging._draggable._onUp(t), this._onMarkerClick(t), o &&
            o.updateContent({
    ...
    _createMiddleMarker: function(t, e) {
      ...
      a.setOpacity(0.6), (t._middleRight = e._middleLeft = a), (o = function() {
        ...
        (a._index = n), a
          ...
          .on(
            ...
            this._onMarkerClick,
            this
          ), (s.lat = a.getLatLng().lat), (s.lng = a.getLatLng().lng), this._spliceLatLngs(
          n,
          0,
          s
        ), this._markers.splice(n, 0, a), a.setOpacity(1), this._updateIndexes(
          n,
          1
        ), e._index++, this._updatePrevNext(t, a), this._updatePrevNext(
          a,
          e
        ), this._poly.fire("editstart");
      }), (n = function() {
        a.off("dragstart", o, this), a.off("dragend", n, this), a.off(
          "touchmove",
          o,
          this
        ), this._createMiddleMarker(t, a), this._createMiddleMarker(a, e);
      }), (i = function() {
        ...
        .on("dragstart", o, this)
        .on("dragend", n, this)
        .on("touchmove", o, this), this._markerGroup.addLayer(a);
    },
    ...
    removeHooks: function() {
      ...
      if ((t.setStyle(t.options.original), t._map)) {
        ...
        (this._resizeMarkers = null), this._map.removeLayer(
          this._markerGroup
        ), delete this._markerGroup;
      }
      this._map = null;
    ...
    _initMarkers: function() {
      this._markerGroup ||
        (this._markerGroup = new L.LayerGroup()), this._createMoveMarker(), this._createResizeMarker();
    },
    ...
    _onMarkerDrag: function(t) {
      ...
      e === this._moveMarker
        ? this._move(i)
        : this._resize(i), this._shape.redraw(), this._shape.fire("editdrag");
    },
    ...
    _onTouchStart: function(t) {
      if (
        ...
        var e = this._getCorners(),
          i = t.target,
          o = i._cornerIndex;
        i.setOpacity(0), (this._oppositeCorner =
          e[(o + 2) % 4]), this._toggleCornerMarkers(0, o);
      }
    ...
    _onTouchMove: function(t) {
      var e = this._map.mouseEventToLayerPoint(t.originalEvent.touches[0]),
        i = this._map.layerPointToLatLng(e),
        o = t.target;
      return o === this._moveMarker
        ? this._move(i)
        : this._resize(i), this._shape.redraw(), !1;
    },
    ...
    _onMarkerDragEnd: function(t) {
      ...
      o === this._moveMarker &&
        (
          ...
          (i = e.getCenter()),
          o.setLatLng(i)
        ), this._toggleCornerMarkers(
        1
      ), this._repositionCornerMarkers(), L.Edit.SimpleShape.prototype._onMarkerDragEnd.call(
        this,
        t
      );
    },
    _move: function(t) {
      for (
        ...
        (e = [i[a].lat - n.lat, i[a].lng - n.lng]), s.push([
          t.lat + e[0],
          t.lng + e[1]
        ]);
      this._shape.setLatLngs(
        s
      ), this._repositionCornerMarkers(), this._map.fire(
    ...
    _resize: function(t) {
      ...
      this._shape.setBounds(
        L.latLngBounds(t, this._oppositeCorner)
      ), (e = this._shape.getBounds()), this._moveMarker.setLatLng(
        e.getCenter()
    ...
    _createResizeMarker: function() {
      ...
      (this._resizeMarkers = []), this._resizeMarkers.push(
    ...
    _initInteractionLegacy: function() {
      if (this.options.clickable) {
        ...
        this._detectIE
          ...
          : e.concat(["touchcancel"]), L.DomUtil.addClass(
          t,
          "leaflet-clickable"
        ), L.DomEvent.on(t, "click", this._onMouseClick, this), L.DomEvent.on(
          t,
          "keypress",
          this._onKeyPress,
          this
    ...
    _lineSegmentsIntersectsRange: function(t, e, i, o) {
      ...
      for (var r = i; r > o; r--)
        if (
          ((n = a[r - 1]), (s = a[r]), L.LineUtil.segmentsIntersect(t, e, n, s))
        )
          return !0;
      return !1;
    },
    ...
    initialize: function(t) {
      L.setOptions(
        this,
        t
      ), (this._modes = {}), (this._actionButtons = []), (this._activeMode = null);
    },
    enabled: function() {
    ...
    addToolbar: function(t) {
      ...
      if (o)
        return (this._lastButtonIndex = --o), (this._actionsContainer = L.DomUtil.create(
          "ul",
          "leaflet-draw-actions"
        )), i.appendChild(this._toolbarContainer), i.appendChild(
    ...
    _initModeHandler: function(t, e, i, o, n) {
      var s = t.type;
      (this._modes[s] = {}), (this._modes[s].handler = t), (this._modes[
        s
      ...
      })), (this._modes[s].buttonIndex = i), this._modes[s].handler
        .on("enabled", this._handlerActivated, this)
        .on("disabled", this._handlerDeactivated, this);
    },
    _createButton: function(t) {
      var e = L.DomUtil.create("a", t.className || "", t.container);
      return (e.href = "#"), t.text && (e.innerHTML = t.text), t.title &&
        (e.title = t.title), L.DomEvent
        .on(e, "click", L.DomEvent.stopPropagation)
    ...
    _disposeButton: function(t, e) {
      L.DomEvent
        .off(t, "click", L.DomEvent.stopPropagation)
    ...
    _handlerActivated: function(t) {
      this.disable(), (this._activeMode = this._modes[
        t.handler
      ]), L.DomUtil.addClass(
    ...
    _handlerDeactivated: function() {
      this._hideActionsToolbar(), L.DomUtil.removeClass(
        this._activeMode.button,
        "leaflet-draw-toolbar-button-enabled"
    ...
    _showActionsToolbar: function() {
      ...
      this._createActions(
        this._activeMode.handler
      ), (this._actionsContainer.style.top = i + "px"), 0 === t &&
        (
          L.DomUtil.addClass(
            this._toolbarContainer,
    ...
    _hideActionsToolbar: function() {
      (this._actionsContainer.style.display = "none"), L.DomUtil.removeClass(
        this._toolbarContainer,
        "leaflet-draw-toolbar-notop"
    ...
    initialize: function(t) {
      (this._map = t), (this._popupPane =
        t._panes.popupPane), (this._container = t.options.drawControlTooltips
        ? L.DomUtil.create("div", "leaflet-draw-tooltip", this._popupPane)
        : null), (this._singleLineLabel = !1), this._map.on(
        "mouseout",
        this._onMouseOut,
        this
      );
    ...
    dispose: function() {
      this._map.off("mouseout", this._onMouseOut, this), this._container &&
        (
    ...
    updatePosition: function(t) {
      var e = this._map.latLngToLayerPoint(t),
        i = this._container;
      return this._container &&
        ((i.style.visibility = "inherit"), L.DomUtil.setPosition(i, e)), this;
    },
    showAsError: function() {
      return this._container &&
        L.DomUtil.addClass(this._container, "leaflet-error-draw-tooltip"), this;
    },
    ...
    initialize: function(t) {
      ...
      (this._toolbarClass =
        "leaflet-draw-draw"), L.Toolbar.prototype.initialize.call(this, t);
    },
    ...
    initialize: function(t) {
      t.edit &&
        ...
        (t.remove = L.extend({}, this.options.remove, t.remove)), t.poly &&
        (t.poly = L.extend(
          {},
          this.options.poly,
          t.poly
    ...
    addToolbar: function(t) {
      ...
      return this._checkDisabled(), this.options.featureGroup.on(
    ...
    _save: function() {
      this._activeMode.handler.save(), this._activeMode &&
    ...
    _revertLayer: function(t) {
      var e = L.Util.stamp(t);
      (t.edited = !1), this._uneditedLayerProps.hasOwnProperty(e) &&
        (
          t instanceof L.Polyline ||
          t instanceof L.Polygon ||
          t instanceof L.Rectangle
    ...
    _enableLayerEdit: function(t) {
      ...
      this._backupLayer(o), this.options.poly &&
        ((i = L.Util.extend({}, this.options.poly)), (o.options.poly = i)), this
    ...
    _disableLayerEdit: function(t) {
      ...
      (e.edited = !1), e.editing && e.editing.disable(), delete e.options
        .editing, delete e.options.original, this._selectedPathOptions &&
    ...
    revertLayers: function() {
      this._deletedLayers.eachLayer(function(t) {
        this._deletableLayers.addLayer(
          t
    ...
    _disableLayerDelete: function(t) {
      var e = t.layer || t.target || t;
      e.off("click", this._removeLayer, this), this._deletedLayers.removeLayer(
        e
      );
    },
    _removeLayer: function(t) {
      var e = t.layer || t.target || t;
      this._deletableLayers.removeLayer(e), this._deletedLayers.addLayer(
        e
      ), e.fire("deleted");
    },
    _onMouseMove: function(t) {
